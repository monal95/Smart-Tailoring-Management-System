...
const CompanyDashboard = () => {
  ...
  const stats = useMemo(() => {
    ...
    const movedToStitching = filteredByTime.filter(
      (o) => o.status === "Moved to Stitching",
    ).length;
    ...
    Object.keys(POSITION_CONFIG).forEach((pos) => {
      positionCounts[pos] = filteredByTime.filter(
        (e) => e.position === pos,
      ).length;
    });
  ...
  const handleDeleteCompany = async () => {
    ...
    try {
      ...
      setToast({
        show: true,
        message: `Company "${companyToDelete.name}" and all associated data deleted successfully`,
        type: "success",
      });
      fetchCompanies();
    } catch (error) {
  ...
  const handleOpenOrderModal = () => {
    setFormError("");
    setOrderForm((prev) => ({ ...prev, orderId: "Auto" }));
  ...
  const calculateTotal = () => {
    const sets = parseInt(orderForm.noOfSets) || 1;
    const shirt = parseFloat(orderForm.shirtAmount) || 0;
    const pant = parseFloat(orderForm.pantAmount) || 0;
                  ...
                  >
                    ...
                    <div className="form-group">
                      ...
                      <input
                        type="tel"
                        name="managerPhone"
                        value={companyForm.managerPhone}
                        onChange={handleCompanyInputChange}
                        className="form-input"
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <input
                        type="tel"
                        name="landlineNumber"
                        value={companyForm.landlineNumber}
                        onChange={handleCompanyInputChange}
                        className="form-input"
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <input
                        ...
                        value={companyForm.estimatedOrders}
                        onChange={handleCompanyInputChange}
                        className="form-input"
                      />
                    </div>
            ...
            >
              ...
              <div className="modal-body">
                ...
                >
                  ...
                  <li>
                    All employee/customer orders (
                    {companyToDelete.totalOrders || 0} orders)
                  </li>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    style={{
                      ...
                      borderColor:
                        deleteConfirmText === `DELETE ${companyToDelete.name}`
                          ? "#16a34a"
                          : "#e2e8f0",
                    }}
                  />
    ...
    <div>
      ...
      <div className="stats-grid mb-4">
        <div
          ...
          style={{
            cursor: "pointer",
            border: activeFilter === "all" ? "2px solid #1e3a8a" : undefined,
          }}
        ...
        <div
          ...
          style={{
            cursor: "pointer",
            border:
              activeFilter === "Moved to Stitching"
                ? "2px solid #9333ea"
                : undefined,
          }}
          onClick={() => handleCardClick("Moved to Stitching")}
        >
          <div className="stat-info">
        ...
        <div className="card mb-4" style={{ backgroundColor: "#eff6ff" }}>
          ...
          >
            <span style={{ fontWeight: "500", color: "#1e3a8a" }}>
              Filtering by:{" "}
              {POSITION_CONFIG[activeFilter]?.label ||
                ...
                {displayOrders.length === 0 ? (
                  ...
                  displayOrders.map((order) => (
                    <tr key={order._id}>
                      ...
                      <td>
                        <span
                          style={{
                            ...
                            color:
                              POSITION_CONFIG[order.position]?.color ||
                              "#64748b",
                          }}
                        >
                          {order.position}
                      ...
                      <td>
                        <span
                          className={`badge ${order.status === "Delivered" || order.status === "Moved to stitching" ? "badge-success" : order.status === "In Progress" ? "badge-info" : "badge-warning"}`}
                        >
                          {order.status}
                        </span>
                      </td>
                        ...
                        >
                          <button
                            ...
                            style={{
                              ...
                              backgroundColor:
                                order.status === "Moved to Stitching" ||
              ...
              >
                ...
                <span
                  style={{
                    ...
                    color:
                      POSITION_CONFIG[selectedOrder.position]?.color ||
                      "#64748b",
                  }}
                >
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {selectedCompany.estimatedOrders || 0}
                    </span>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    <span
                      className={`badge ${selectedCompany.status === "Active" ? "badge-success" : "badge-warning"}`}
